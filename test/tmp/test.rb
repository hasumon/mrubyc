...
#
# Genarated at: 2019-04-01 14:23:28 +0900
...
class BlockTest < MrubycTestCase
  description "block"
...
information = { :test_class_name => "MyAliasTest", :method_name => "method1_case", :path => "/home/hasumi/work/mrubyc/test/my_alias_test.rb", :line => 9, :description => "alias" }
my_case = MyAliasTest.new(information)
my_case.setup
my_case.method1_case
my_case.check_mock
my_case.teardown

information = { :test_class_name => "MyAliasTest", :method_name => "method1_case", :path => "/home/hasumi/work/mrubyc/test/my_alias_test.rb", :line => 15, :description => "override original method" }
my_case = MyAliasTest.new(information)
my_case.setup
my_case.method1_case
my_case.check_mock
...
information = { :test_class_name => "MyAliasTest", :method_name => "method1_case", :path => "/home/hasumi/work/mrubyc/test/my_alias_test.rb", :line => 21, :description => "override alias method" }
my_case = MyAliasTest.new(information)
my_case.setup
my_case.method1_case
my_case.check_mock
...
information = { :test_class_name => "MathTest", :method_name => "all", :path => "/home/hasumi/work/mrubyc/test/math_test.rb", :line => 6, :description => "Math class" }
my_case = MathTest.new(information)
my_case.setup
my_case.all
my_case.check_mock
my_case.teardown

information = { :test_class_name => "BlockTest", :method_name => "all", :path => "/home/hasumi/work/mrubyc/test/block_test.rb", :line => 6, :description => "block" }
my_case = BlockTest.new(information)
my_case.setup
my_case.all
my_case.check_mock
my_case.teardown
...
information = { :test_class_name => "MyBlockTest", :method_name => "all", :path => "/home/hasumi/work/mrubyc/test/my_block_test.rb", :line => 6, :description => "block" }
my_case = MyBlockTest.new(information)
my_case.setup
my_case.all
my_case.check_mock
my_case.teardown

information = { :test_class_name => "MyInstanceVariableTest", :method_name => "all", :path => "/home/hasumi/work/mrubyc/test/my_instance_variable_test.rb", :line => 6, :description => "instance variable" }
my_case = MyInstanceVariableTest.new(information)
my_case.setup
my_case.all
my_case.check_mock
my_case.teardown

information = { :test_class_name => "MySuperTest", :method_name => "all", :path => "/home/hasumi/work/mrubyc/test/my_super_test.rb", :line => 6, :description => "super" }
my_case = MySuperTest.new(information)
my_case.setup
my_case.all
my_case.check_mock
my_case.teardown

information = { :test_class_name => "ObjectTest", :method_name => "alias_case", :path => "/home/hasumi/work/mrubyc/test/object_test.rb", :line => 5, :description => "alias" }
...
information = { :test_class_name => "ObjectTest", :method_name => "all", :path => "/home/hasumi/work/mrubyc/test/object_test.rb", :line => 11, :description => "Object class" }
my_case = ObjectTest.new(information)
my_case.setup
my_case.all
my_case.check_mock
...
information = { :test_class_name => "MyEqual3Test", :method_name => "all", :path => "/home/hasumi/work/mrubyc/test/my_equal3_test.rb", :line => 6, :description => "===" }
my_case = MyEqual3Test.new(information)
my_case.setup
my_case.all
my_case.check_mock
my_case.teardown
